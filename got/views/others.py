...
def ot_pdf(request, num_ot):
    ...
    tareas = Task.objects.filter(ot=ot_info, 
                                #  start_date__gte=start_date_filter, 
                                #  start_date__lte=end_date_filter
                                 ).select_related('responsible', 'responsible__profile').order_by('start_date')
    ...
    images_qs = Image.objects.filter(task__ot=ot_info, 
                                    #  creation__gte=start_date_filter.date(), 
                                    #  creation__lte=end_date_filter.date()
                                     ).order_by('creation')
