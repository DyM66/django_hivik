...
class Estator(models.Model):
    ...
    pi_1min_l1_tierra = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pi_1min_l2_tierra = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pi_1min_l3_tierra = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pi_1min_l1_l2 = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pi_1min_l2_l3 = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pi_1min_l3_l1 = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)

    pi_10min_l1_tierra = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pi_10min_l2_tierra = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pi_10min_l3_tierra = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pi_10min_l1_l2 = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pi_10min_l2_l3 = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pi_10min_l3_l1 = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    ...
    pf_1min_l1_tierra = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pf_1min_l2_tierra = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pf_1min_l3_tierra = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pf_1min_l1_l2 = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pf_1min_l2_l3 = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pf_1min_l3_l1 = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)

    pf_10min_l1_tierra = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pf_10min_l2_tierra = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pf_10min_l3_tierra = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pf_10min_l1_l2 = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pf_10min_l2_l3 = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pf_10min_l3_l1 = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
...
class Excitatriz(models.Model):
    ...
    megger = models.OneToOneField(Megger, on_delete=models.CASCADE)
    pi_1min_l_tierra = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pi_10min_l_tierra = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pi_obs_l_tierra = models.TextField(null=True, blank=True)

    pf_1min_l_tierra = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    pf_10min_l_tierra = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
